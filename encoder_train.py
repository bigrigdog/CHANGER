...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "clean_data_root",
        type=Path,
        help="Path to the output directory of encoder_preprocess.py. If you left the default "
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Number of steps between updates of the umap projection. Set to 0 to never update the "
        "projections.",
    )
    parser.add_argument(
        "-s",
