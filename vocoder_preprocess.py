...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "datasets_root",
        type=Path,
        help="Path to the directory containing your SV2TTS directory. If you specify both --in_dir and "
    ...
    parser.add_argument(
        ...
        help="Path to the synthesizer directory that contains the mel spectrograms, the wavs and the "
    ...
    parser.add_argument(
        ...
        type=Path,
        default=argparse.SUPPRESS,
        help="Path to the output vocoder directory that will contain the ground truth aligned mel "
